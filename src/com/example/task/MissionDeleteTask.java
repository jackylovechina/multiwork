...
public class MissionDeleteTask extends AsyncTask<Long, Integer, String> {
	Context context;

	public MissionDeleteTask(Context context) {
		super();
	...
	protected String doInBackground(Long... params) {
		...
		String path = "http://172.16.150.118:8080/MultiWork/deletemission.do";
